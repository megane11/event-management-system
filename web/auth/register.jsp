    ...
    <body class="flex items-center flex-col justify-center h-screen">
        ...
        <form method='POST' action='../RegisterServlet' class='m-auto flex flex-col min-w-[400px] gap-5' enctype="multipart/form-data">
            ...
            <div class="flex flex-col gap-3 relative">
                <!-- Image uploader -->
                <div class="absolute left-[110%] top-0 h-[200px] w-1/2 flex items-center justify-center bg-cover bg-no-repeat bg-center border border-violet-400">
                    <label for="input-file" id="drop-area" class="w-full h-full flex items-center justify-center flex-col">
                        ...
                        <div class="border h-full flex flex-col gap-2 items-center justify-center w-full border-2-dashed border-violet-400 bg-pending-bg rounded-sm bg-no-repeat bg-cover bg-center" id="img-view">
                            <i class="fas fa-cloud-upload text-violet-400 text-3xl font-semibold"></i>
